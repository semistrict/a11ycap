...
import { log, initializeLogging } from "./logging.js";
import { setupA11yCapTools } from "./mcp-server.js";
import { PrimaryBrowserConnectionManager, RemoteBrowserConnectionManager, setBrowserConnectionManager, getBrowserConnectionManager } from "./browser-connection-manager.js";
...
async function main() {
  ...
  if (isPrimary) {
    try {
      ...
      log.error("Failed to start primary server, falling back to remote:", error);
